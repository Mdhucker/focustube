...
export const kids_nav = [
  { icon: FaDog, text: "Puppy Fun & Facts", link: "/kids/puppies" },
  { icon: FaCat, text: "Kitty Corner", link: "/kids/kittens" },
  { icon: FaFish, text: "Colorful Fish World", link: "/kids/fish" },
  { icon: FaFrog, text: "Frogs & Friends", link: "/kids/frogs" },
  { icon: FaPaw, text: "Meet the Zoo Animals", link: "/kids/zoo" },
  { icon: FaBook, text: "Animal Stories", link: "/kids/stories" },
  { icon: FaLeaf, text: "Save the Jungle!", link: "/kids/conservation" },
  { icon: FaCamera, text: "Animal Photo Fun", link: "/kids/photos" },
  { icon: FaHeart, text: "Pet Care Basics", link: "/kids/pet-care" },
  { icon: FaSmile, text: "Fun Animal Games", link: "/kids/games" },
];



export const health_nav = [
  { icon: FaDumbbell, text: "Home Workouts", link: "/health/workouts" },
  { icon: FaAppleAlt, text: "Healthy Eating", link: "/health/nutrition" },
  { icon: FaHeartbeat, text: "Heart Health Tips", link: "/health/heart" },
  { icon: FaBrain, text: "Mental Wellness", link: "/health/mental" },
  { icon: FaLeaf, text: "Natural Remedies", link: "/health/remedies" },
  { icon: FaWeight, text: "Weight Loss Plans", link: "/health/weight-loss" },
  { icon: FaSpa, text: "Yoga & Meditation", link: "/health/yoga" },
  { icon: FaBed, text: "Better Sleep Habits", link: "/health/sleep" },
